...
bool RRTstarPlanner::init_planner_real_robot_goal_pose(const Eigen::Affine3d& goal, const vector<int> constraint_vec_goal_pose, const vector<pair<double,double> > target_coordinate_dev, const string planner_type)
{
...
bool RRTstarPlanner::init_planner_real_robot_goal_config(const vector<double> goal, const string planner_type)
{
...
void RRTstarPlanner::setPlanningSceneInfo(vector<double> size_x, vector<double> size_y, string scene_name)
{
