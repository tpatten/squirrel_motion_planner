...
class BiRRTstarPlanner //: public robot_interface_definition::RobotInterface
{
    ...
    vector<double> getFullPoseFromEEPose(const vector<double> &endEffectorPose, const vector<pair<double, double> > &endEffectorDeviations, const vector<double> &poseInit);
