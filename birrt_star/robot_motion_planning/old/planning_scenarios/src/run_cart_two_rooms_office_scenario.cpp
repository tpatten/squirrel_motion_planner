/*
 *run_cart_two_rooms_office_scenario.cpp
 *
...
{
    //Init Node
    ros::init(argc, argv, "run_cart_two_rooms_office_scenario_node");
    ...
    string folder_path = terminal_configs_path + "/Start_Goal_Configurations/" + PLANNING_GROUP + "_two_rooms_start_goal_config.txt";
