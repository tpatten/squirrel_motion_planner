/*
 *run_cart_parking_slot_scenario.cpp
 *
...
{
    //Init Node
    ros::init(argc, argv, "run_cart_parking_slot_scenario_node");
    ...
    string folder_path = terminal_configs_path + "/Start_Goal_Configurations/" + PLANNING_GROUP + "_parking_start_goal_config.txt";
