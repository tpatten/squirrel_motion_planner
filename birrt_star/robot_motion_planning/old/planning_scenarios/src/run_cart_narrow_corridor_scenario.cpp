/*
 *run_cart_narrow_corridor_scenario.cpp
 *
...
{
    //Init Node
    ros::init(argc, argv, "run_cart_narrow_corridor_scenario_node");
    ...
    double wall_length_ratio = 0.2;
    world_builder.insertNarrowCorridor(corridor_width, wall_length_ratio);

    //Path to the file containing the start and goal config for the scenario
    char* file_path_start_goal_config;
    string folder_path = terminal_configs_path + "/Start_Goal_Configurations/" + PLANNING_GROUP + "_corridor_start_goal_config.txt";
    ...
    permitted_coordinate_dev[4].second = 0.32;   //positive Yrot deviation
