...
{
    //Init Node
    ros::init(argc, argv, "run_cart_tunnel_scenario_node");
    ...
    world_builder.insertTunnelPassage(tunnel_width, tunnel_height, wall_length_ratio);


    //Path to the file containing the start and goal config for the scenario
    char* file_path_start_goal_config;
    string folder_path = terminal_configs_path + "/Start_Goal_Configurations/" + PLANNING_GROUP + "_tunnel_start_goal_config.txt";
