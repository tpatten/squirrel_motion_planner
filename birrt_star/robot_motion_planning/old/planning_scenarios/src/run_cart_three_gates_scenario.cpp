/*
 *run_cart_three_gates_scenario.cpp
 *
...
{
    //Init Node
    ros::init(argc, argv, "run_cart_three_gates_scenario_node");
    ...
    string folder_path = terminal_configs_path + "/Start_Goal_Configurations/" + PLANNING_GROUP + "_three_gates_start_goal_config.txt";
