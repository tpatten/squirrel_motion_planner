        ...
        planner_msgs::planning_scene_info::Response& res)
{
    ...
    m_bi_planner->setPlanningSceneInfo(req.env_size_x, req.env_size_y, "motion_plan");
    m_uni_planner->setPlanningSceneInfo(req.env_size_x, req.env_size_y, "motion_plan");
                           ...
                           planner_msgs::run_planner_poses::Response& res)
{
    ...
    if(req.planner_type == "bi")
    {
        ...
        initialization_ok = m_bi_planner->init_planner(req.start_ee_pose,req.constraint_vec_start_pose,req.goal_ee_pose,constraint_vec_goal_pose,target_coordinate_dev_local,1); //1 = C-Space search space
    }
    else if(req.planner_type == "uni")
    {
        //Reset planner data
        m_uni_planner->reset_planner_only();
        //Init planner with start and goal ee pose
        initialization_ok = m_uni_planner->init_planner(req.start_ee_pose,req.constraint_vec_start_pose,req.goal_ee_pose,constraint_vec_goal_pose,target_coordinate_dev_local,1);
    }
    else
    {
        ROS_ERROR("Planner type not known! (Available options: 'bi'' or 'uni')");
...
bool PlanningControlCenter::run_planner_real_robot_goal_pose(planner_msgs::run_planner_real_robot_goal_pose::Request& req,
                           planner_msgs::run_planner_real_robot_goal_pose::Response& res)
{
    ...
    if(req.planner_type == "bi")
    {
        ...
        initialization_ok = m_bi_planner->init_planner_real_robot_goal_pose(goal_pose,constraint_vec_goal_pose, target_coordinate_dev_local, req.planner_type);
    }
    else if(req.planner_type == "uni")
    {
        //Reset planner data
        m_uni_planner->reset_planner_only();
        //Init planner for real robot
        initialization_ok = m_uni_planner->init_planner_real_robot_goal_pose(goal_pose,constraint_vec_goal_pose, target_coordinate_dev_local, req.planner_type);
    }
    else
    {
        ROS_ERROR("Planner type not known! (Available options: 'bi'' or 'uni')");
...
bool PlanningControlCenter::run_planner_real_robot_goal_config(planner_msgs::run_planner_real_robot_goal_config::Request& req,
                           planner_msgs::run_planner_real_robot_goal_config::Response& res)
{
    ...
    if(req.planner_type == "bi")
    {
        ...
        m_bi_planner->reset_planner_only();
        //Init planner for real robot
        initialization_ok = m_bi_planner->init_planner_real_robot_goal_config(req.goal_config, req.planner_type);
    }
    else if(req.planner_type == "uni")
    {
        //Reset planner data
        m_uni_planner->reset_planner_only();
        //Init planner for real robot
        initialization_ok = m_uni_planner->init_planner_real_robot_goal_config(req.goal_config, req.planner_type);
    }
    else
    {
        ROS_ERROR("Planner type not known! (Available options: 'bi'' or 'uni')");
