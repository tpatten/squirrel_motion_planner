...
protected:
    ...
    //+++++++++ Services for Planning Execution (Simulation) +++++++++
    ...
    //+++++++++ Services for Planning Execution (Real Robot considering /map frame) +++++++++
    ...
    ros::ServiceServer m_run_planner_real_robot_goal_pose; /**< Service to run planner with current configuration as start config and desired end-effector goal pose expressed w.r.t map frame */

    //Run planner with current configuration as start config and a desired goal config
    ros::ServiceServer m_run_planner_real_robot_goal_config; /**< Service to run planner with current configuration as start config and desired goal config expressed w.r.t map frame*/


    //TODO:
    // -> Add service to set end-effector constraints or include it in the existing messages
