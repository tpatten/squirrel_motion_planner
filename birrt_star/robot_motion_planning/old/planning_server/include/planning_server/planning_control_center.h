...
#include <planner_msgs/run_planner_real_robot_goal_pose.h>
#include <planner_msgs/run_planner_real_robot_goal_config.h>
...
public:
    ...
    //+++++++++ Planning Execution Service Callbacks (Real Robot considering /map frame) +++++++++
    // -> Note: goal pose or config is given w.r.t map frame

    bool run_planner_real_robot_goal_pose(planner_msgs::run_planner_real_robot_goal_pose::Request& req,
                               planner_msgs::run_planner_real_robot_goal_pose::Response& res); /**< Service callback to run planner with current configuration as start config and desired EE goal pose */

    bool run_planner_real_robot_goal_config(planner_msgs::run_planner_real_robot_goal_config::Request& req,
                               planner_msgs::run_planner_real_robot_goal_config::Response& res); /**< Service callback to run planner with current configuration as start config and desired goal config */
