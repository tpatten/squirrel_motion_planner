/*
 *run_birrt_star_algorithm_pr2_lbr.cpp
 *
...
{
    //Init Node
    ros::init(argc, argv, "birrt_star_algorithm_pr2_base_node");
    ...
    string planning_group = "pr2_base";
...
//    constraint_vec_goal_pose[5] = 1; //RotZ
    ...
    //Set EE Goal endeffector pose and constraint variables
    vector<double> ee_goal_pose(6);
    ee_goal_pose[0] = 4.5;       //X
    ee_goal_pose[1] = -4.0;       //Y
    ee_goal_pose[2] = 0.0;       //Z
    ee_goal_pose[3] = 0.0;    //RotX
