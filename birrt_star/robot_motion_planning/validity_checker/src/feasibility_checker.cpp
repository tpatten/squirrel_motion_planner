...
//    cin>>t;
 ...
 //     new kuka_motion_controller::KDLRobotModel(robot_desciption_param, planning_scene_ns, endeffector_trajectory_ns, m_planning_group));
...
//Check whether an tree node config is valid (i.e. whether it is Collision-Free)
bool FeasibilityChecker::isConfigValid(const KDL::JntArray &config, bool print_contacts)
{
  ++checkCount;
...
//Check whether an tree edge is valid (i.e. whether all of it Configuration are Collision-Free)
bool FeasibilityChecker::isEdgeValid(const Edge &tree_edge, bool print_contacts)
{
  //Iterate through configurations of the edge (edp = EDge Points)
  for (int edp = 0; edp < tree_edge.joint_trajectory.size(); edp++)
  {
...
//    for (int i = 0; i < m_num_joints; i++)
//    {
//      if (m_joint_names[i] == "base_x_joint")
//        config[0] = tree_edge.joint_trajectory[edp][i];
//      else if (m_joint_names[i] == "base_y_joint")
//        config[1] = tree_edge.joint_trajectory[edp][i];
//      else if (m_joint_names[i] == "base_theta_joint")
//        config[2] = tree_edge.joint_trajectory[edp][i];
//      else if (m_joint_names[i] == "arm_joint1")
//        config[3] = tree_edge.joint_trajectory[edp][i];
//      else if (m_joint_names[i] == "arm_joint2")
//        config[4] = tree_edge.joint_trajectory[edp][i];
//      else if (m_joint_names[i] == "arm_joint3")
//        config[5] = tree_edge.joint_trajectory[edp][i];
//      else if (m_joint_names[i] == "arm_joint4")
//        config[6] = tree_edge.joint_trajectory[edp][i];
//      else if (m_joint_names[i] == "arm_joint5")
...
//Check whether an tree edge is valid (i.e. whether all of it Configuration are Collision-Free)
// -> additionally returns index of last valid node
bool FeasibilityChecker::isEdgeValid(const Edge &tree_edge, int &last_valid_node_idx, bool print_contacts)
{
  last_valid_node_idx = 0;
