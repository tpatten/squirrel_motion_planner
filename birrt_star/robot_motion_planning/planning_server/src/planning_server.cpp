...
PlanningServer::PlanningServer()
{
    ...
    //+++++++++ Bind Services for Planning Execution (Simulation) +++++++++
    ...
    //+++++++++ Bind Services for Planning Execution (Real Robot considering /map frame) +++++++++
    ...
    m_run_planner_real_robot_goal_pose = nh.advertiseService("run_planner_real_robot_goal_pose", &PlanningControlCenter::run_planner_real_robot_goal_pose, &m_planning_control_center);

    //Run planner with current configuration as start config and a desired goal config
    m_run_planner_real_robot_goal_config = nh.advertiseService("run_planner_real_robot_goal_config", &PlanningControlCenter::run_planner_real_robot_goal_config, &m_planning_control_center);
